...
<div className="mt-12 block space-y-6 sm:grid sm:gap-6 sm:space-y-0 sm:grid-cols-2 lg:grid-cols-4 auto-rows-[200px] md:auto-rows-[250px]">  {aiToolsData.map((tool, index) => (
    <div
      key={index}
